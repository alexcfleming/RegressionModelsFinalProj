...
- Yes, automatic cars get better fuel efficiency expressed as MPG, but the best other predictors include the number of engine cylinders, vehicle weight, and engine horsepower.
- The impact of automatic cars on MPG is the coefficient 1.80921, which means that there is an improvement of about 1.8 mpg shifting to automatic from manual. 
...
We begin with some basic exploration based on hypotheses. An initial idea might be that the number of cylinders combined with the transmission type can explain the difference in fuel efficiency. We attempt this model first.
